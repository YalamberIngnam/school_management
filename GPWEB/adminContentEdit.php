						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit Content</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-list"></i> <span>Content Information</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										...
										<?php 
											...
											$stmt = "SELECT * FROM contents INNER JOIN teachers ON contents.content_teacher=teachers.teacher_id WHERE contents.content_id='$content_id'";
											$contents = query($stmt);
											$contents->execute(); 
											foreach ($contents as $content) {?>
										<form method="POST" enctype="multipart/form-data">
											<label>Topic name: </label><input type="text" name="content_name" placeholder="Topic Name" value="<?php echo($content['content_name']); ?>" required><br>
											<label>Topic Description: </label><textarea name="content_description"><?php echo($content['content_description']); ?></textarea><br>
													...
													<table class="table table-hover"> 
														...
														<tbody>
															<tr>
																...
																<td><?php echo $content['content_file']; ?></td>
																<td><?php echo $content['teacher_firstname'].' on '.$content['content_addedOn'] ?></td>
															</tr> 											
																<?php } ?>						
														</tbody> 
													</table>
