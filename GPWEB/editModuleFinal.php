						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit Module</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-list"></i> <span>Module Information</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										...
										<form method="POST">
											<label>Module Name:</label><input type="text" name="module_name" placeholder="Unique ID" value="<?php echo($module['module_name']); ?>" required><br>
											<label>Module Actual Name: </label><textarea name="module_description" required><?php echo($module['module_description']); ?></textarea><br>
