						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-license"></i> <span>Assign Module to a Teacher</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-database"></i> <span>Modules assigned to Teachers</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										<section id="section-1">
											<div class="graph">
												<?php addModuleTeacher(); ?>
												<div class="tables">
																...
																<select name="module_id">
																	...
																	<?php 
																		...
																		foreach ($modules as $module) { ?>
																			<option value="<?php echo $module['module_id']; ?>"><?php echo $module['module_name'] . ' [' . $module['module_description'] . ']'; ?></option>
																		<?php } ?>
																</select><br>
															<label>Teacher</label>
																<select name="teacher_id">
																	...
																	<?php 
																		...
																		foreach ($teachers as $teacher) { ?>
																			<option value="<?php echo $teacher['teacher_id']; ?>"><?php echo $teacher['teacher_firstname'] . ' ' . $teacher['teacher_surname']; ?></option>
																		<?php } ?>
																</select><br>
										...
										<section id="section-2">
											<?php 
												if (isset($_GET['module_id'])) {
													...
													if (deleteModuleTeacher($module_id,$teacher_id)) {
														echo "Module Teacher Successfully Deleted.";
													}
													else {
											...
											<div class="graph">
												<div class="tables">
													<table class="table table-hover"> 
														...
														<tbody>														
															<?php 
																$stmt = "SELECT * FROM modules INNER JOIN module_teacher ON modules.module_id=module_teacher.module_id INNER JOIN teachers ON module_teacher.teacher_id=teachers.teacher_id";
																$modules = query($stmt);
																$modules->execute();
																$num = 1;
																foreach ($modules as $module) {?>
															<tr>
																...
																<td>
																	<a href="moduleTeacher.php?module_id=<?php echo($module['module_id']); ?>
																	&teacher_id=<?php echo($module['teacher_id']); ?>" style="text-align: center; color: red;"><i class="lnr lnr-trash"></i></a>
																</td>
															</tr> 											
																<?php } ?>						
														</tbody> 
