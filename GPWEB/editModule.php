						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit or <i class="lnr lnr-trash"></i>Delete Module</span></a></li>
										</ul>
									</nav>
													...
													<table class="table table-hover"> 
														...
														<tbody>														
															...
															<tr>
																...
																<td>
																	<a href="editModuleFinal.php?module_id=<?php echo $module['module_id']; ?>">Edit</a>
																	<a href="editModule.php?module_id=<?php echo $module['module_id'] ?>" style="color: red;">Delete</a>
																</td>
															</tr> 											
																<?php } ?>						
														</tbody> 
