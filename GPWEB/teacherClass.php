						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-enter"></i> <span>Add Teacher to a Class</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-database"></i> <span>Teachers Added to Classes</span></a></li>
										</ul>
									</nav>
										...
										<section id="section-2">
											<?php 
												if (isset($_GET['teacher_id'])) {
													...
													if (deleteTeacherClass($teacher_id,$class_id)) {
														echo "Teacher Successfully Removed from a Class.";
													}
													else {
											...
											<div class="graph">
												<div class="tables">
													<table class="table table-hover"> 
														...
														<tbody>														
															<?php 
																$stmt = "SELECT * FROM teachers INNER JOIN teacher_class ON teachers.teacher_id=teacher_class.teacher_id INNER JOIN classes ON teacher_class.class_id=classes.class_id";
																$teachers = query($stmt);
																$teachers->execute();
																$num = 1;
																foreach ($teachers as $teacher) {?>
															<tr>
																...
																<td>
																	<a href="teacherClass.php?teacher_id=<?php echo($teacher['teacher_id']); ?>
																	&class_id=<?php echo($teacher['class_id']); ?>" style="text-align: center; color: red;"><i class="lnr lnr-trash"></i></a>
																</td>
															</tr> 											
																<?php } ?>						
														</tbody> 
