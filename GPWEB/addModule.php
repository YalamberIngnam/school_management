						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-upload"></i> <span>Add Module</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-briefcase"></i> <span>All Modules</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										...
										<?php addModule(); ?>
										<form method="POST">
											<label>Module Name:</label><input type="text" name="module_name" placeholder="Unique ID" required><br>
											<label>Module Actual Name: </label><textarea name="module_description" required></textarea><br>
											<input type="submit" name="submit" value="Add New Module">
										</form>
										</section>
											...
											<div class="graph">
												<div class="tables">
													<table class="table table-hover"> 
														...
														<tbody>														
															<?php 
																$stmt = "SELECT * FROM modules GROUP BY module_id DESC";
																$modules = query($stmt);
																$modules->execute();
																$num = 1;
