						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit or <i class="lnr lnr-trash"></i>Delete Teacher</span></a></li>
										</ul>
									</nav>
													...
													<table class="table table-hover"> 
														...
														<tbody>														
															...
															<tr>
																...
																<td>
																	<a href="editTeacherFinal.php?teacher_id=<?php echo $teacher['teacher_id']; ?>">Edit</a>
																	<a href="editTeacher.php?teacher_id=<?php echo $teacher['teacher_id'] ?>" style="color: red;">Delete</a>
																</td>
															</tr> 											
																<?php } ?>						
														</tbody> 
