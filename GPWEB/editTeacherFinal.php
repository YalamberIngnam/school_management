						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit Teacher</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-list"></i> <span>Teacher Information</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										...
										<?php 
											...
											<div class="mediabox">
												<input type="text" name="teacher_firstname" placeholder="Firstname"
												value="<?php echo($teacher['teacher_firstname']); ?>" required><br>
												...
												<input type="submit" name="submit" value="Edit Teacher">
											</div>
											</form>
													...
													<table class="table table-hover"> 
														...
														<tbody>
															<tr>
																...
																<td><?php echo $teacher['user_type']; ?></td>
															</tr> 											
																<?php } ?>						
														</tbody> 
													</table>
