						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit Student</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-list"></i> <span>Student Information</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										...
										<?php 
											...
											$stmt = "SELECT * FROM students INNER JOIN classes ON students.student_class=classes.class_id WHERE students.student_id='$student_id'";
											$student = query($stmt);
											$student->execute(); 
											...
											<div class="mediabox">
												<input type="text" name="student_firstname" placeholder="Student Firstname" value="<?php echo($student['student_firstname']); ?>" required><br>
												<input type="text" name="student_surname" placeholder="Student Surname" value="<?php echo($student['student_surname']); ?>" required><br>
												...
												<input type="email" name="student_email" placeholder="Student Email" value="<?php echo($student['student_email']); ?>" required><br>
												<input type="date" name="student_dateOfBirth" placeholder="Student Birth Date" value="<?php echo($student['student_dateOfBirth']); ?>" required><br>
												<input type="number" name="student_contact" placeholder="Student Contact" value="<?php echo($student['student_contact']); ?>" required><br>
												<select name="student_class" required>
													...
													<?php
														...
														foreach ($classes as $grade) {
															if ($student['student_class'] == $grade['class_id']) {
																$selected = "selected";
															}
															else {
																$selected = "";
															}?>
															<option value="<?php echo $grade['class_id']; ?>" <?php echo $selected; ?>><?php echo $grade['class_name']; ?></option>
														<?php } ?>
												</select><br>
