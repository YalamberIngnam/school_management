						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit or <i class="lnr lnr-trash"></i>Delete Class</span></a></li>
										</ul>
									</nav>
											...
											<div class="graph">
												<div class="tables">
													<table class="table table-hover"> 
														...
														<tbody>														
															<?php 
																$stmt = "SELECT * FROM classes GROUP BY class_id DESC";
																$classes = query($stmt);
																$classes->execute();
																$num = 1;
															...
															<tr>
																...
																<td>
																	<a href="editClassFinal.php?class_id=<?php echo $class['class_id']; ?>">Edit</a>
																	<a href="editClass.php?class_id=<?php echo $class['class_id'] ?>" style="color: red;">Delete</a>
																</td>
															</tr> 											
																<?php } ?>						
														</tbody> 
