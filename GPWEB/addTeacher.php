						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-upload"></i> <span>Add Teacher</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-graduation-hat"></i> <span>All Teachers</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										...
										<div class="mediabox">
											<input type="text" name="teacher_firstname" placeholder="Firstname" required><br>
											<input type="text" name="teacher_surname" placeholder="Surname" required><br>
											<select name="teacher_gender">
												<option value="M">Male</option>
												<option value="F">Female</option>
											</select><br>
											<input type="email" name="teacher_email" placeholder="Email" required><br>
											<input type="password" name="teacher_password" placeholder="Password" required><br>
											<input type="password" name="c_t_password" placeholder="Confirm Password" required><br>
											<input type="date" name="teacher_dateOfBirth" required><br>
											<input type="number" name="teacher_contact" placeholder="Contact Number" required><br>
											<input type="text" name="teacher_qualification" placeholder="Qualification" required><br>
											...
											<div class="graph">
												<div class="tables">
													<table class="table table-hover"> 
														...
														<tbody>														
															<?php 
																$stmt = "SELECT * FROM teachers GROUP BY teacher_firstname ASC";
																$teachers = query($stmt);
																$teachers->execute();
																$num = 1;
															...
															<tr>
																...
																<td><?php echo $teacher['teacher_firstname'].' '.$teacher['teacher_surname']; ?></td>
																<td>
																	<?php 
																...
																<td><?php echo $teacher['teacher_dateOfBirth']; ?></td>
																<td><?php echo $teacher['teacher_contact']; ?></td>
																<td><?php echo $teacher['teacher_qualification']; ?></td>
															</tr> 											
																<?php } ?>						
														</tbody> 
													</table>
