						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-file-add"></i> <span>Add Module to a Class</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-database"></i> <span>Modules added to Classes</span></a></li>
										</ul>
									</nav>
										...
										<section id="section-2">
											<?php 
												if (isset($_GET['module_id'])) {
													...
													if (deleteModuleClass($module_id,$class_id)) {
														echo "Module Class Successfully Deleted.";
													}
													else {
											...
											<div class="graph">
												<div class="tables">
													<table class="table table-hover"> 
														...
														<tbody>														
															<?php 
																$stmt = "SELECT * FROM modules INNER JOIN module_class ON modules.module_id=module_class.module_id INNER JOIN classes ON module_class.class_id=classes.class_id";
																$modules = query($stmt);
																$modules->execute();
																$num = 1;
																foreach ($modules as $module) {?>
															<tr>
																...
																<td>
																	<a href="moduleClass.php?module_id=<?php echo($module['module_id']); ?>
																	&class_id=<?php echo($module['class_id']); ?>" style="color: red;"><i class="lnr lnr-trash"></i></a>
																</td>
															</tr> 											
																<?php } ?>						
														</tbody> 
