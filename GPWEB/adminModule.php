...
<body>
	<div class="page-container">
							...
							<div id="tabs" class="tabs">
								...
								<h2 class="inner-tittle">
									<?php
										...
										echo $module['module_name'].': '.$module['module_description']; 
									?>	
								</h2>
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-list"></i> <span>All Contents</span></a></li>
											<li><a href="#section-2" class="icon-cup"><i class="lnr lnr-file-add"></i> <span>Add New Content</span></a></li>
											<li><a href="#section-3" class="icon-lab"><i class="lnr lnr-select"></i> <span>Add Attendance</span></a></li>
											<li><a href="#section-4" class="icon-lab"><i class="lnr lnr-chart-bars"></i> <span>Attendance Details</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
												...
												<div class="tables">
													<table class="table table-hover"> 
														...
														<tbody>														
															<?php 
																$module_id = $_GET['module_id'];
																$stmt = "SELECT * FROM contents INNER JOIN modules ON contents.content_module=modules.module_id INNER JOIN teachers ON contents.content_teacher=teachers.teacher_id WHERE modules.module_id='$module_id' ORDER BY contents.content_name ASC";
																$contents = query($stmt);
																$contents->execute();
																$num = 1;
															...
															<tr>
																...
																<td>
																	<a href="adminContentEdit.php?content_id=<?php echo $content['content_id']; ?>
																		&module_id=<?php echo $module_id; ?>
																		">Edit</a>
																	<a href="adminModule.php?content_id=<?php echo $content['content_id']; ?>
																		&module_id=<?php echo $module_id; ?>
																		" style="color: red">Delete</a>
																	<a href="uploads/<?php echo $content['content_file']; ?>" download="<?php echo $content['content_file']; ?>"><li class="fa fa-cloud-download"></li></a>
																</td>
															</tr> 											
																<?php } ?>						
														</tbody> 
										...
										<?php addContent(); ?>
											<form method="POST" enctype="multipart/form-data" action="adminModule.php?module_id=<?php echo($_GET['module_id']); ?>">
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					<li id="menu-academico"><a href="admin.php"><i class="fa fa-home"></i> <span>Home</span></a></li>
