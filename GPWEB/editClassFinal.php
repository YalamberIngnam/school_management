						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-magic-wand"></i> <span>Edit Class</span></a></li>
											<li><a href="#section-2" class="icon-shop"><i class="lnr lnr-list"></i> <span>Class Information</span></a></li>
										</ul>
									</nav>
									<div class="content tab">
										...
										<?php 
											...
											editClass($class_id);
											$stmt = "SELECT * FROM classes WHERE class_id=$class_id";
											$classes = query($stmt);
											$classes->execute(); 
											foreach ($classes as $class) {?>
										<form method="POST">
											<label>Class Name:</label><input type="text" name="class_name" placeholder="Unique ID" value="<?php echo($class['class_name']); ?>" required><br>
